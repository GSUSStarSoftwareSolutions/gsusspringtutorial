package com.luv2code.deleteJavaObject;
...
import com.luv2code.deleteJavaObject.dao.StudentDAO;
import com.luv2code.deleteJavaObject.entity.Student;



@SpringBootApplication
public class DeleteJavaObjectApplication {

	public static void main(String[] args) {
		SpringApplication.run(DeleteJavaObjectApplication.class, args);
	}
