package com.luv2code.queryJavaObject;
...
import com.luv2code.queryJavaObject.dao.StudentDAO;
import com.luv2code.queryJavaObject.entity.Student;


@SpringBootApplication
public class QueryJavaObjectApplication {

	public static void main(String[] args) {
		SpringApplication.run(QueryJavaObjectApplication.class, args);
	}
