package com.luv2code.updateJavaObject;
...
import com.luv2code.updateJavaObject.dao.StudentDAO;
import com.luv2code.updateJavaObject.entity.Student;


@SpringBootApplication
public class UpdateJavaObjectApplication {

	public static void main(String[] args) {
		SpringApplication.run(UpdateJavaObjectApplication.class, args);
	}
